...
<style lang='less'>
@titleCardColor: #000;
@descriptTextColor: #4a5667;
@buttonCardBackground: #edf2f7;
@shadowCardColor: #e3e3e3;
@cardColor: #fff;
.main{
  display: block;
  position: relative;
  ...
  &>ul{
    ...
    .itemServices{
      ...
      border-radius: 4px;
      overflow: hidden;
      box-shadow: 0 7px 14px @shadowCardColor, 0 10px 10px @shadowCardColor;
      ...
      .descript{
        ...
        form{
          ...
          button{
            ...
            border-radius: 10px;
            border: none;
            background: @buttonCardBackground;
          }
        }
      }
    }
